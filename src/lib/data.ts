...
export const seedBookings: Booking[] = [
  ...
  pack({
    ...
    status: "completed",
    pickup: "TPE T2 Arrivals",
    pickupZh: "桃園機場 T2 到達",
    dropoff: "Taipei 101",
    dropoffZh: "台北 101",
    when: "2026-03-20T16:10",
    vehicle: "mpv",
    passengers: 4,
    luggage: 3,
    extras: ["meet"],
  ...
  pack({
    ...
    pickup: "Xinyi",
    pickupZh: "信義",
    dropoff: "Songshan TSA",
    dropoffZh: "松山機場",
    when: "2026-03-28T08:40",
    vehicle: "premium",
    passengers: 2,
    luggage: 1,
    extras: ["english"],
    driverId: "d1",
    passengerId: "p1",
    createdAt: "2026-03-27T21:00:00+08:00",
    passengerName: "Amara Chen",
    passengerPhone: "+886 900 880 101",
    channel: "app",
    payment: "line",
    price: 2680,
    breakdown: b("Premium", "豪華", 2680),
  }),
  pack({
    id: "ZF-82041",
    service: "airport_pickup",
