...
export const seedBookings: Booking[] = [
  ...
  pack({ id: "ZD-1811", service: "p2p", status: "onboard", pickup: "Da'an Park", pickupZh: "大安森林公園", dropoff: "Taipei 101", dropoffZh: "台北 101", when: "2026-09-23T11:40", vehicle: "sedan", passengers: 2, luggage: 1, extras: [], driverId: "d4", passengerId: "p1", createdAt: "2026-09-23T11:32:00+08:00", passengerName: "Amara Chen", passengerPhone: "+886 900 880 101", channel: "app", payment: "card", price: 1280, breakdown: b("Sedan", "舒適轎車", 1280) }),
  pack({ id: "ZD-1812", service: "airport_pickup", status: "accepted", pickup: "TPE T1 Arrivals", pickupZh: "桃園機場第一航廈到達", dropoff: "Da'an", dropoffZh: "大安", when: "2026-09-24T16:40", vehicle: "mpv", passengers: 5, luggage: 4, extras: ["meet", "child_seat"], flight: "CI101", driverId: "d3", passengerId: "p1", createdAt: "2026-09-22T18:00:00+08:00", passengerName: "Amara Chen", passengerPhone: "+886 900 880 101", channel: "web", payment: "card", price: 2630, breakdown: b("MPV + meet + seat", "商務＋舉牌＋座椅", 2630) }),
];
